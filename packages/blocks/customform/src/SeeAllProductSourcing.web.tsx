...
import SeeAllProductSourcingController, {
  Props,
  configJSON,
} from "./SeeAllProductSourcingController";

export default class SeeAllProductSourcingWeb extends SeeAllProductSourcingController {
