...
import DriverRegistrationType from "../../src/DriverRegistrationType";
...
const screenProps = {
  ...
  id: "DriverRegistrationType",
};

const feature = loadFeature(
  "./__tests__/features/driver-reg-type.scenario.feature"
);
  ...
  "data": [
      {
          ...
          "attributes": {
              "contact_support_number": "+918962256651"
          }
      }
  ]
}
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to select registraion type", ({ given, when, then }) => {
    given("The page loaded properly", () => {
      screen = render(<DriverRegistrationType {...screenProps} />);
      ...
      screen.container.instance.setCustomCareNumber = msgValidationAPI.messageId;
      const { receive: mockReceive } = screen.container.instance;
    ...
    when("User clicks on next", () => {
      ...
      fireEvent.press(screen.getByTestId("item-type-0"));
      fireEvent.press(screen.getByTestId("nextBtn"));
    });
