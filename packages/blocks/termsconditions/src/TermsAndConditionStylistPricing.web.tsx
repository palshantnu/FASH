...
export default class TermsAndConditionStylistPricingWeb extends TermsAndConditionStylistPricingController {
  ...
  render() {
    // Customizable Area Start
    return (
      <SafeAreaView style={styles.container} testID="TermsAndConditionStylistPricing">
        <this.Header />
      </SafeAreaView>
    );
    // Customizable Area End
