...
defineFeature(feature, (test) => {
    ...
    test('User navigates to Upvotedownvote', ({ given, when, then }) => {
        ...
        then('I can press the like button without errors', () => {
            let buttonComponent = UpvotedownvoteWrapper.findWhere((node) => node.prop('testID') === 'likeBtn');
        ...
        then('I can press the dislike button without errors', () => {
            let buttonComponent = UpvotedownvoteWrapper.findWhere((node) => node.prop('testID') === 'disLikeBtn');
            buttonComponent.simulate('press')
