...
import Applepayintegration2Controller, {
  Props,
  configJSON,
} from "./Applepayintegration2Controller";

export default class Applepayintegration2 extends Applepayintegration2Controller {
