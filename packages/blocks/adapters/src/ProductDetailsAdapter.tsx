...
export default class ProductDetailsAdapter {
  ...
  convert(from: Message): Message {
    ...
    to.addData(getName(MessageEnum.NavigationTargetMessage), "ProductDetails");
    ...
    raiseMessage.addData(
      getName(MessageEnum.productIDMessage),
      from.getData(getName(MessageEnum.productIDMessage))
    );
