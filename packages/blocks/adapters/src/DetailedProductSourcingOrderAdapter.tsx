...
export default class DetailedProductSourcingOrderAdapter {
  ...
  convert(from: Message): Message {
    ...
    to.addData(getName(MessageEnum.NavigationTargetMessage), "DetailedProductSourcingOrder");
    ...
    raiseMessage.addData(
      ...
      from.getData(getName(MessageEnum.DetailedProductSourcingOrderData))
    );
