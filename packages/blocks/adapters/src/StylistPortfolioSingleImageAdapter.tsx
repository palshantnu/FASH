...
export default class StylistPortfolioSingleImageAdapter {
  ...
  convert(from: Message): Message {
    ...
    const raiseMessage: Message = new Message(
      ...
      raiseMessage.addData(
        getName(MessageEnum.StylistPortfolioSingleImage),
        from.getData(getName(MessageEnum.StylistPortfolioSingleImage))
      );
