...
export default class TapWebViewForStylistPlan {
  ...
  constructor() {
    ...
    runEngine.attachBuildingBlock(this as IBlock, [
      getName(MessageEnum.NavigationTapWebViewForStylistPlanMessage),
    ]);
  }
  ...
  convert(from: Message): Message {
    ...
    const raiseMessage: Message = new Message(
      ...
      raiseMessage.addData(
        ...
        from.getData(getName(MessageEnum.NavigationTapWebViewForStylistPlanMessageData))
      );
