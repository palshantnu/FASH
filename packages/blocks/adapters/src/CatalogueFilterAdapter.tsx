...
export default class CatalogueFilterAdapter {
  ...
  convert(from: Message): Message {
    ...
    to.addData(getName(MessageEnum.NavigationTargetMessage), "CatalogueFilter");
    ...
    raiseMessage.addData(
      ...
      from.getData(getName(MessageEnum.CatalogueFilters))
    );
