...
export default class TermsAndConditionStylistPricingAdapter {
  ...
  convert(from: Message): Message {
    ...
    const raiseMessage: Message = new Message(
      ...
      raiseMessage.addData(
        getName(MessageEnum.NavigationTermsAndConditionStylistPricingData),
        from.getData(getName(MessageEnum.NavigationTermsAndConditionStylistPricingData))
      );
