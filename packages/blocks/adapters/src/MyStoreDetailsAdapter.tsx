...
export default class MyStoreDetailsAdapter {
  ...
  convert(from: Message): Message {
    ...
    to.addData(getName(MessageEnum.NavigationTargetMessage), "MyStoreDetails");
    ...
    raiseMessage.addData(
      ...
      from.getData(getName(MessageEnum.NavigationPayloadMyStoreIdMessage))
    );
