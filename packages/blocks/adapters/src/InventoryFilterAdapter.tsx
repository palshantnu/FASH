...
export default class InventoryFilterAdapter {
  ...
  constructor() {
    ...
    runEngine.attachBuildingBlock(this as IBlock, [
      getName(MessageEnum.NavigationInventoryFilterMessage),
    ]);
  }
  ...
  convert(from: Message): Message {
    ...
    const raiseMessage: Message = new Message(
      ...
      raiseMessage.addData(
        ...
        from.getData(getName(MessageEnum.NavigationInventoryFilterData))
      );
