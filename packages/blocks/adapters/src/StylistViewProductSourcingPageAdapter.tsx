...
export default class StylistViewProductSourcingPageAdapter {
  ...
  convert(from: Message): Message {
    ...
    const raiseMessage: Message = new Message(
      ...
      raiseMessage.addData(
        getName(MessageEnum.StylistViewProductSourcingPage),
        from.getData(getName(MessageEnum.StylistViewProductSourcingPage))
      );
