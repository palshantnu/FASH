...
export default class AddCardAdapter {
  ...
  constructor() {
    ...
    runEngine.attachBuildingBlock(this as IBlock, [
      getName(MessageEnum.NavigationAddCard),
    ]);
  }
  ...
  convert(from: Message): Message {
    ...
    to.addData(getName(MessageEnum.NavigationTargetMessage), "AddCard");
    to.addData(
    ...
    raiseMessage.addData(
      ...
      from.getData(getName(MessageEnum.NavigationPayloadAddCard))
    );
