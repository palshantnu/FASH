...
export default class OrderManagementBuyerSummaryAdapter {
  ...
  convert = (from: Message): Message => {
    ...
    raiseMessage.addData(
        getName(MessageEnum.OrderIdNavigationPayloadMessage), 
        from.getData(getName(MessageEnum.OrderIdNavigationPayloadMessage))
    );
