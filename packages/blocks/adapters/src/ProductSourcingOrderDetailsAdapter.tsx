...
export default class ProductSourcingOrderDetailsAdapter {
  ...
  convert(from: Message): Message {
    ...
    to.addData(getName(MessageEnum.NavigationTargetMessage), "ProductSourcingOrderDetails");
    ...
    raiseMessage.addData(
      ...
      from.getData(getName(MessageEnum.ProductSourcingOrderDetailsData))
    );
