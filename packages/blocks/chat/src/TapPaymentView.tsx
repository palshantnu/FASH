...
import TapPaymentViewController, {
  Props,
} from "./TapPaymentViewController";
// Customizable Area End

export default class TapPaymentView extends TapPaymentViewController {
  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container} ref={this.scrollRef} testID="TapPaymentsView">
