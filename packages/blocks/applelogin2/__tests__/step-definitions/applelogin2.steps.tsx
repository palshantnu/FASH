...
import Applelogin2 from "../../src/Applelogin2"
...
const feature = loadFeature('./__tests__/features/applelogin2-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to applelogin2', ({ given, when, then }) => {
        ...
        then('applelogin2 will load with out errors', () => {
            let buttonComponent = exampleBlockA.findWhere((node) => node.prop('testID') === 'btnTouchFeedback');
