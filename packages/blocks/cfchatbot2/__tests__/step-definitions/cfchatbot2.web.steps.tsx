...
import Cfchatbot2 from '../../src/Cfchatbot2.web';
...
const feature = loadFeature('./__tests__/features/cfchatbot2-scenario.web.feature');
...
defineFeature(feature, (test) => {
	...
	test('User navigates to cfchatbot2 and inputs text', ({ given, when, then }) => {
	...
	test('User navigates to cfchatbot2 and inputs a password', ({ given, when, then, and }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Cfchatbot2;
