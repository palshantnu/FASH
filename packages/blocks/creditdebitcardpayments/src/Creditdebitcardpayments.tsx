...
import CreditdebitcardpaymentsController, {
  Props,
  configJSON,
} from "./CreditdebitcardpaymentsController";

export default class Creditdebitcardpayments extends CreditdebitcardpaymentsController {
