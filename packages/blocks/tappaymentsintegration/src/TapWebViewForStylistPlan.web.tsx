...
export default class TapWebViewForStylistPlanWeb extends TapWebViewForStylistPlanController {
  ...
  render() {
    // Customizable Area Start
    return (
      <SafeAreaView style={styles.container} testID="TapWebViewForStylistPlan">
        <this.Header />
      </SafeAreaView>
    );
    // Customizable Area End
