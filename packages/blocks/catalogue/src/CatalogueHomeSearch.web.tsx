...
import CatalogueHomeSearchController, {
  Props,
  configJSON,
} from "./CatalogueHomeSearchController";

export default class CatalogueHomeSearchWeb extends CatalogueHomeSearchController {
